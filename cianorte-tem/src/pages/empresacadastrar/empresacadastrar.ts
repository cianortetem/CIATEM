...
export class EmpresacadastrarPage {s
  ...
  createForm(){
      ...
      fone2:         [this.empresa.fone2, Validators.required],
      celular:       [this.empresa.celular, Validators.required],
      siteempresa:   [this.empresa.siteempresa, Validators.required],
      horarioatend1: [this.empresa.horarioatend1, Validators.required],
      horarioatend2: [this.empresa.horarioatend2, Validators.required],
      horarioatend3: [this.empresa.horarioatend3, Validators.required],
